...
local function install_profiles(num)
    ...
    local repoOwner = shared.RiseMode and "PSWalloz/RiseProfiles" or "Erchobg/VoidwareProfiles"
...
local url = shared.RiseMode and "https://github.com/PSWalloz/tuff-v4/" or "https://github.com/PSWalloz/tuff-v4"
local commit = "main"
...
local function vapeGithubRequest(scripturl, isImportant)
    ...
    local url = (scripturl == "MainScript.lua" or scripturl == "GuiLibrary.lua") and shared.RiseMode and "https://raw.githubusercontent.com/PSWalloz/tuff-v4/" or "https://raw.githubusercontent.com/PSWalloz/tuff-v4/"
